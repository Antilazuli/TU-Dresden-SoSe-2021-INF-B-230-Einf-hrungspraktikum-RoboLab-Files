...
class PDControler:
    ...
    def motorsMove_waitTillFinish(self, distanceL, distanceR, speed):
        self.motorsRawMovement(self, distanceL, distanceR, speed)
    ...
    def motorsTurnToMedian(self):
        ...
        offset = (self.medianBW - light) * 0.3
        self.motorsMove_waitTillFinish(-offset, offset, self.motorSpeed)

    def motorsTurnToPath(self, degToExpectedPath):

        self.motorsRawMovement(degToExpectedPath * self.ticPerDeg, -degToExpectedPath * self.ticPerDeg)
